...
其中，Node节点网段为`192.168.2.0/24`，k8s pod网段为`172.16.0.0/16`，service网段为`10.96.0.0/16`，kube-dns ip地址为`10.96.0.10`，k8s api vip地址为`192.168.2.24`，k8s service ip地址为`10.96.0.1`，kubernetes版本为`v1.24.16`，etcd版本为`v3.5.9`，helm版本为`v3.12.3`，calico版本为`v3.25.0`，您可以直接批量替这些ip或版本以适应您的环境。
